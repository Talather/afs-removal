        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            {isAuthenticated ? (
              ...
              <>
                <Button
                  className="relative z-10 flex items-center overflow-hidden text-white h-8 justify-center w-fit px-4 rounded-sm bg-button-gpt hover:bg-[#1c9aee] transition-all duration-200 before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-[200%] before:h-full 
