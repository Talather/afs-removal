      ...
      "
              ...
              <>
                <li className="relative z-50">
                  <Button
                    className="relative z-10 flex items-center overflow-hidden text-white  justify-center w-full px-4  bg-button-gpt hover:bg-[#1c9aee] transition-all duration-200 before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-[200%] before:h-full 
                    rounded-full
            "
                    to="/consultation"
                    as={NavLink}
